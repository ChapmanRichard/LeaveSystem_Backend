...
namespace Api.Common.AntiXSS
{
    internal class CssScanner
    {
        ...
        public AntiyXSSResult ScanStyleSheet(string css, int maxinputsize, bool fromStyleAttribute)
        {
            ...
            return new AntiyXSSResult(start, !string.IsNullOrEmpty(cleanStyleSheet) ? cleanStyleSheet.Trim() : cleanStyleSheet, _errors);
        }
