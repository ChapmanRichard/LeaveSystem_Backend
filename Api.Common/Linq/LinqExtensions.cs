...
namespace Api.Common.Linq
{
    public static class LinqExtensions
    {
        ...
        /// <returns></returns>
        public static Expression<Func<T, bool>> In<T>(this Expression<Func<T, bool>> first, string[] options, string fieldName)
        {
            return first.Compose(GetConditionExpression<T>(options, fieldName), Expression.AndAlso);
        }
        ...
        public static Expression<Func<T, bool>> In<T, TValue>(this Expression<Func<T, bool>> first, Expression<Func<T, TValue>> obj, IEnumerable<TValue> values)
        {
            return first.Compose(BuildContainsExpression(obj, values), Expression.AndAlso);
        }
    ...
    {
        public string[] GetPropertyNames<T>(params Expression<Func<T, object>>[] propertyExpression)
        {
            List<string> list = new List<string>();
            foreach (var item in propertyExpression)
            {
                string strField = item.GetPropertyName();
                if (strField != "")
                {
                    list.Add(strField);
                }
        ...
        public string GetPropertyName<T>(Expression<Func<T, object>> propertyExpression)
        {
