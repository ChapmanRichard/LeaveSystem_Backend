---
name: generate-webapi-tests
description: "Use when: 需要根据现有 WebAPI 代码与需求文档自动生成单元测试、接口测试或数据库集成测试，重点覆盖 API 契约、Mock 规范、数据库状态清理与可重复执行。关键词: WebAPI, 单元测试, 集成测试, Mock, API契约, Database-State-Cleanup, Req_ER.md"
---
